				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
							<a href="/dirput/edit/{{$value->id_dirput}}" class="btn btn-sm btn-outline-warning px-3">edit</a>
							<button type="button" class="btn btn-sm btn-outline-danger px-3" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $value->id_dirput }}">
								hapus</button>
						</td>
					</tr>
					@endforeach
